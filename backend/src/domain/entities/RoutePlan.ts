export interface RoutePlanProps { id: string; userId: string; startLocation: string; date: string; distanceKm: number; elevationGainM: number; favorableWind: boolean; createdAt: Date; }
...
export class RoutePlan {
  private constructor(public readonly id: string, public readonly userId: string, public readonly startLocation: string, public readonly date: string, public readonly distanceKm: number, public readonly elevationGainM: number, public readonly favorableWind: boolean, public readonly createdAt: Date) {}
  static create(props: RoutePlanProps): RoutePlan {
    ...
    return new RoutePlan(props.id, props.userId, startLocation, props.date, props.distanceKm, props.elevationGainM, props.favorableWind, props.createdAt);
  }
}
