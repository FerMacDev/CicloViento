...
export function StartLocationMap({latitude,longitude,startLocation,geometry=[]}:{latitude:number;longitude:number;startLocation:string;geometry?:RouteCoordinate[]}) {
